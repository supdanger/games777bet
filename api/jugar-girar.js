...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Las tres consultas salen juntas: antes iban una atrás de otra,
    // sumando latencia al giro sin necesidad (ninguna depende del
    // resultado de la anterior, solo del slug y el clientId).
